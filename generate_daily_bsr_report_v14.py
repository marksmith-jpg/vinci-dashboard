            ...
            if is_translation_series(sname):
                ...
                if not is_box:
                    series_rt_books[sname].append({
                        ...
                        "ebooks_paid_sold": b.get("ebooks_paid_sold", 0),
                        "image": b.get("image", ""),
                    })
            elif is_box:
...
def compute_ad_efficiency(series_30):
    ...
    for series in series_30:
        ...
        # Cost per reader acquired
        book1_readers = book1["total_reads"]
...
def generate_html(portfolio, authors, authors_90, series_30, series_90, readthrough_90, readthrough_30,
    ...
    def _ad_row(f, roi_class):
        ...
        <tr>
            ...
            <td class="num">{curr_symbol}{f['cost_per_reader']:.4f}</td>
        </tr>"""
        ...
        <div class="section">
            ...
            <div class="table-wrapper" style="margin-bottom: 1.5rem;">
                <table class="data-table">
                    ...
                    <thead><tr><th>Series / Author</th><th>Books</th><th>Spend</th><th>Gross</th><th>ROI</th><th>Cost/Reader <span style="font-size:0.65rem;font-weight:400;color:var(--text-muted);" title="Ad spend ÷ total KENP page reads. Measures how much you pay per reader acquired through ads.">(?)</span></th></tr></thead>
