        ...
        if prev_date:
            ...
            for r in latest_recs:
                ...
                if key and key in prev_map:
                    ...
                    # Fix: Only consider books whose CURRENT BSR is in the top 100,000
                    # This filters out long-tail noise from single-sale spikes.
                    if prev_bsr and curr_bsr and prev_bsr > 0 and 0 < curr_bsr <= 100000:
        ...
        mover_html = f"""
            <div class="mover-kpi-inner">
                ...
                <div class="mover-kpi-text">
                    ...
                    <div class="kpi-sublabel" style="font-size:0.6rem;color:var(--text-muted);margin-bottom:0.2rem;">Among titles ranked in top 100K</div>
